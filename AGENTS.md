...
### Web Fetch Error Handling (2026-04-28)

**问题背景：** 在2026-04-28的任务中，web_fetch工具出现了7次错误（共28次工具调用），错误率高达25%。
...
`C:\Users\zhaoxinkui\.openclaw-autoclaw\skills/<skill-name>/SKILL.md`
